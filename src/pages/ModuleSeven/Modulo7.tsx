...
function Modulo7() {
  ...
  const exemploDoCypress = [
    { label: "Exemplo 1", rota: ApplicationRoutes.MODULO_SETE_EXEMPLO_CYPRESS },
  ];

  const exemploDosTestesUnitarios = [
    {
      label: "Exemplo 1",
      rota: ApplicationRoutes.MODULO_SETE_EXEMPLO1_TESTE_UNITARIO,
    },
    {
      label: "Exemplo 2",
      rota: ApplicationRoutes.MODULO_SETE_EXEMPLO2_TESTE_UNITARIO,
    },
  ];
